                                    ...
                                    <div class="container-fluid d-flex flex-column">
                                        <div class="flex-1 flex-lg-0">
                                            <div class="d-inline-flex justify-content-center">
                                                <img src="<?= isset($_SESSION['student_photo']) ? $_SESSION['student_photo'] : '/public/assets/images/user.png' ?>" alt="" class="rounded-pill" style="width: 80px; height: 80px">
                                            </div>
                                            <div class="d-inline-block ms-3">
                                                <h3 class="mb-0 fw-bold"><?= $_SESSION['student_fname'] . " " . $_SESSION['student_lname'] ?></h3>
                                                <h5 class="mb-0 fw-bold"><?= $_SESSION['student_number'] ?></h5>
                                                <h5 class="mb-0 fw-bold"><?= $_SESSION['student_course'] ?></h5>
                                            </div>
                                            <div class="float-md-end float-center d-inline-block ms-3">
                                                <h3 class="mb-0 fw-bold"><br></h3>
                                                <button class="btn btn-light text-white" style="background: #095C00" onclick="window.location = '/student/profile'">My Profile</button>
