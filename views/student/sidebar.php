    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section">
            <div class="sidebar-section-body d-flex justify-content-center">
                <h5 class="sidebar-resize-hide flex-grow-1 my-1">Student</h5>
            ...
            <div class="container-fluid d-flex flex-column mt-3 pb-2 mb-2">
                <div class="navbar-brand flex-1 flex-lg-0">
                    <a href="/student/profile" class="d-inline-flex justify-content-center">
                        <img id="studentPhoto" src="<?= isset($_SESSION['student_photo']) ? $_SESSION['student_photo'] : '/public/assets/images/user.png' ?>" alt="" class="rounded-pill" style="width: 35px; height: 35px">
                    </a>
                    <div class="d-sm-inline-block ms-3">
                        <p id="studentName" class="mb-0 fw-bold text-uppercase" style="font-size: 16px"><?=substr($_SESSION['student_fname'] . " " . $_SESSION['student_lname'], 0, 19) . "<br>" . substr($_SESSION['student_fname'] . " " . $_SESSION['student_lname'], 19) ?></p>
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item mb-1">
                    <a href="/student/dashboard" class="nav-link <?= ($currentUrl == '/student/dashboard') ? 'active fw-bold' : '' ?>">
                ...
                <li class="nav-item mb-1">
                    <a href="/student/linkage_and_partners" class="nav-link <?= ($currentUrl == '/student/linkage_and_partners') ? 'active fw-bold' : ''; ?>">
                ...
                <li class="nav-item mb-1">
                    <a href="/student/institutional_membership" class="nav-link <?= ($currentUrl == '/student/institutional_membership') ? 'active fw-bold' : ''; ?>">
                ...
                <li class="nav-item mb-1">
                    <a href="/student/ojt_partners" class="nav-link <?= ($currentUrl == '/student/ojt_partners') ? 'active fw-bold' : ''; ?>">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input class="form-control" type="text" value="<?= $_SESSION['student_fname'] . ' ' . $_SESSION['student_lname'] ?>" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input class="form-control" type="text" value="<?= $_SESSION['student_number'] ?>" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
...
<?php
    ...
    if (isset($_POST['password_change'])) {
        ...
        $sql = "SELECT * FROM `tbl_users` WHERE `user_email` = ? LIMIT 1";
